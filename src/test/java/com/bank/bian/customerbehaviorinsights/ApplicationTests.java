...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Customer Behavior Insights");
        assertThat(meta).containsEntry("functionalPattern", "Analyze");
    }

    @Test
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/customer-behavior-model-analysis/initiate",
