package com.bank.bian.customerbehaviorinsights.model;
...
/**
 * The BIAN control record for this service domain: "Customer Behavior Model Analysis".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Analyze) applied
 * to its asset type (Customer Behavior Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Behavior Model Analysis";
